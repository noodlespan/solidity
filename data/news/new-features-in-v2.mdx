---
title: '222听 Arbitrum 创始人谈未来发展之路：与 Arbitrum One 并行的扩容技术已在路上'
date: 2021-08-08
lastmod: '2021-09-11'
tags: ['Arbitrum', 'Steven Goldfeder']
draft: false
summary: 'Arbitrum 将继续吸收最先进的技术，积极推动扩容领域的发展 。'
layout: PostSimple
---
...
A demo of a multiple author post is shown in [Introducing Tailwind Nextjs Starter Blog post](/news/introducing-tailwind-nextjs-starter-blog).
